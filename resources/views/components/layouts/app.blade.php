...
<flux:sidebar sticky stashable
    ...
    <flux:brand href="/dashboard" logo="logo.png" wire:navigate name="{{ config('app.name') }}" class="px-2 dark:hidden"/>
    <flux:brand href="/dashboard" logo="logo.png" wire:navigate name="{{ config('app.name') }}" class="px-2 hidden dark:flex"/>
