        ...
        <div>
            ...
            <div class="flex items-center gap-2 justify-center">
                <flux:modal.trigger name="select-vs">
                    <flux:button variant="primary" color="green"  :disabled="$dhcpStatus === 'running' || $dhcpStatus === 'loading'" icon="play" class="cursor-pointer">Start</flux:button>
                </flux:modal.trigger>
                ...
                <div class="absolute right-2 bottom-2 text-xs">
                    ...
                    <flux:link target="_blank" :href="$dhcpNets">
                        DHCP Netze anzeigen
        ...
        <flux:modal name="select-vs" variant="flyout">
            <div class="space-y-6">
                ...
                <div class="flex gap-2">
                    ...
                    <flux:button variant="primary" color="green" type="submit" wire:click.prevent="startDhcp" class="cursor-pointer">
                        Start
                    </flux:button>
                </div>
            </div>
