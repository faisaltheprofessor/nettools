<flux:dropdown name="anliegen">
    ...
    >
        <!-- Top bar: quick link to all Anliegen -->
        ...
        <div class="flex gap-2 justify-end">
            <flux:button
                ...
                kbd="esc"
                class="w-28"
                x-on:click="$flux.dropdown('anliegen').close()"
            >
                Abbrechen
            </flux:button>
            <flux:button size="sm" kbd="⏎" class="w-28" wire:click="submit">
                Absenden
            </flux:button>
        </div>
    </flux:popover>
...
<script>
    function feedbackPopover() {
        return {
            emojiOpen: false,
            emojis: [
                // A wide but flat set of cross-platform standard emojis
                '😀','😁','😂','🤣','😃','😄','😅','😆','😉','😊','😋','😎','😍','😘','🥰','😗','😙','😚','🙂','🤗','🤩','🤔','🤨','😐','😑','😶','🙄','😏','😣','😥','😮','🤐','😯','😪','😫','🥱','😴','😌','😛','😜','😝','🤤','😒','😓','😔','😕','🙃','🫠','😖','😞','😟','😤','😢','😭','😦','😧','😨','😩','🤯','😬','😰','😱','🥵','🥶','😳','🤪','😵','🥴','😠','😡','🤬','🤥','🤒','🤕','🤢','🤮','🤧','😇','🥳','🥸','🤠','🤡','🤫','🤭','🫢','🫶','🙏','👍','👎','👊','✊','👏','🙌','🤝','💪','🖐️','👌','✌️','🤞','🤟','🤘','👉','👈','👆','👇','☝️','✍️','🖕',
                '🐶','🐱','🐭','🐹','🐰','🦊','🐻','🐼','🐨','🐯','🦁','🐮','🐷','🐸','🐵','🐔','🐧','🐦','🐤','🦆','🦅','🦉','🦇','🐺','🐴','🦄','🐝','🪲','🐢','🐍','🦖','🐙','🦑','🦀','🐡','🐠','🐟','🐬','🐳','🦈','🐘','🦛','🦏','🐪','🐫','🦒','🐐','🦌','🦙','🐓','🦃','🕊️','🦤','🦦','🦫','🦔',
                '🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍒','🍑','🥭','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🌽','🥕','🥔','🍠','🥐','🍞','🥯','🥖','🥨','🥞','🧀','🍗','🍖','🥩','🥓','🍔','🍟','🍕','🌭','🥪','🌮','🌯','🥙','🥚','🍳','🍝','🍜','🍣','🍱','🍤','🍙','🍚','🍛','🍩','🍪','🎂','🍰','🧁','🍫','🍬','🍿','☕','🍵','🥤','🍺','🍻','🍷','🥂','🥃','🍸','🍹',
                '⚽','🏀','🏈','⚾','🎾','🏐','🥏','🎱','🏓','🏸','🥅','🥊','🥋','🎽','🛼','🛹','⛸️','🏂','🏄','🚣','🏊','🚴','🚵','🤸','🤼','🤺','🎯','🎳','🎮','🎲','🎼','🎤','🎧','🎷','🎸','🎹','🎺','🎻','🥁',
